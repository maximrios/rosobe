		...
		<fieldset> 
		    <div class="fila">
		        <label for="vcPaisNombre">Nombre del Pais</label>
		       	<input type="text" name="vcPaisNombre" id="vcPaisNombre" value="<?= $Reg['vcPaisNombre']; ?>"<?=classRegValidation('vcPaisNombre')?> style="width: 250px;"/>
		    </div>         
	        <div class="clearfloat">&nbsp;</div>
		</fieldset> 
		<br/>
		<div class="buttons">
			<input type="submit" class="button guardar btn-accion<?= (empty($Reg['inIdPais'])?' btn-reset':''); ?>" value="Guardar"/>
