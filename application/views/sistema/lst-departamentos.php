...
$vcNombreList = (!empty($vcNombreList))? $vcNombreList: 'Departamentos';
...
<div class="box-layout-50-rt">
	<div class="toolbar-rgt-sb">
  	<div class="toolbar-rgt-sb-der">
  		<div class="forms">
  			<form id="frmBuscador" name="frmBuscador" action="sistema/departamentos/listado" method="post" target="contenido-abm">
  				<div class="fila">
                    ...
                    <?php if($txtvcBuscar): ?>
                    <a href="sistema/departamentos/listado" target="contenido-abm" class="btn-accion limpiar btn-reset limpiarBusqueda" title="Limpiar Búsqueda">&nbsp;</a>
                    <?php endif; ?>
  	...
  	<div class="toolbar-rgt-sb-izq">
  		<a href="sistema/departamentos/formulario" id="btn-nuevo" class="button agregar btn-accion">Agregar Nuevo</a>
  	</div>
		<div class="clearfloat">&nbsp;</div>
	</div>
</div>
