<section class="content wrap-content row">
	...
	<div class="col-lg-9">
		...
		<div class="row" style="">
			<figure class="col-xs-12 col-sm-6 col-md-4 col-lg-3" style="text-align:center;padding: 0.4em 0;margin:0.3em;background:white;border: 1px solid #D9D9D9;">
				<a href="assets/images/productos/imagen1.jpg" rel="prettyPhoto"><img src="assets/images/productos/imagen1_thumb2.jpg" alt=""></a>
				<figcaption>
