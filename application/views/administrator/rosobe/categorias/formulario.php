...
?>
	...
	<form id="<?=$vcFormName;?>" name="<?=$vcFormName;?>" action="<?=$vcFrmAction;?>" method="post" target="contenido-abm" enctype="multipart/form-data">
    	...
    	<div class="buttons">
			<input id="btnnuevo" type="submit" class="btn-primary btn-accion" value="Guardar"/>
		</div>
    ...
    /*$(function () {
        'use strict';
        var url = "<?=base_url()?>administrator/categorias/guardar";
...
$(function () {
    ...
    var url = 'administrator/categorias/guardar',
        uploadButton = $('<button/>')
