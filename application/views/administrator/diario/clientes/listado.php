...
?>
	...
	<div class="accionesd">
		...
		<a href="administrator/clientes/formulario" id="btn-nuevo" class="btn btn-primary btn-accion"><i class="icon-ok icon-white"></i>&nbsp;&nbsp;Agregar Nuevo</a>
		<a href="administrator/reportes/clientes" id="btn-imprimir" target="_blank" class="btn"><i class="icon-print"></i>&nbsp;&nbsp;Imprimir Listado</a>
		<form id="frmBuscador" name="frmBuscador" action="administrator/clientes/listado" method="post" target="contenido-abm">
